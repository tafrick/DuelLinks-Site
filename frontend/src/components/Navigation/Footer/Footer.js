    ...
    return (
        <div className={styles.Footer}>
            ...
            <div className="foot" style={{display: "contents", background: "no-repeat", margin: "auto", width: "50%", padding: "10px"}}>
                ...
                <a href="http://store.steampowered.com/app/601510/" target="_blank">
                ...
                <a href='https://play.google.com/store/apps/details/?id=jp.konami.duellinks&pcampaignid=pcampaignidMKT-Other-global-all-co-prtnr-py-PartBadge-Mar2515-1' target="_blank">
                ...
                <a href="https://apps.apple.com/de/app/yu-gi-oh-duel-links/id1068378177?mt=8" target="_blank">
